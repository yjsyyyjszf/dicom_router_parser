...
def export_to_excel(output_path: str = 'default_path', output_filename: str = 'default_filename', tab_name: str = '', stat_list_of_lists: list = []) -> str:
...
if __name__ == "__main__":
    ...
    all_tag_list = parse_dicom_tag_dump(headers, output_folderpath)
