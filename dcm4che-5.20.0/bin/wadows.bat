...
set MAIN_JAR=dcm4che-tool-wadows-5.20.0.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-mime-5.20.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-tool-common-5.20.0.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-xdsi-5.20.0.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\jakarta.activation-1.2.1.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\jakarta.xml.bind-api-2.3.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\jaxb-runtime-2.3.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\istack-commons-runtime-3.0.8.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\stax-ex-1.8.1.jar
